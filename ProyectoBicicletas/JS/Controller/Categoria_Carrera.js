...
/**
 * Clase que proporciona métodos para interactuar con las categorías de carrera.
 */
export class Categoria_Carrera {
     ...
     * 
     * @returns {Promise} - Una promesa que se resuelve con la lista de categorías de carrera o se rechaza con un error.
     */
